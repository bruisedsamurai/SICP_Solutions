...
(newline)
(display (negate (make-polynomial 'x (list '(5 0) '(4 1) (list 1 (make-rational 22 7)) '(0 0)))))
(newline)
(display (sub
          (make-polynomial 'x (list '(5 0) '(4 1) '(2 1) (list 0 (make-rational 10 1))))
          (make-polynomial 'x (list '(5 0) '(4 1) '(1 1) '(0 1)))))
(newline)