...
(equ? 6 6)
(equ? (make-rational 5 7) (make-rational 5 8))
(equ? (make-complex-from-mag-ang 5 7) (make-complex-from-mag-ang 5 8))
(equ? (make-complex-from-real-imag 5 7) (make-complex-from-real-imag 5 7))